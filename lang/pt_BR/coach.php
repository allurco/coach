...
return [
    ...
    'plan' => [
        ...
        'empty_pending' => 'Nada pendente por aqui.',
        'empty_in_progress' => 'Sem ações em andamento.',
        'empty_completed' => 'Nada concluído ainda — bora começar.',
        'empty_all' => 'Sem ações nesse goal. Pede pro coach criar a primeira.',
        'view_all' => 'Ver todas →',
        'mark_done' => 'Concluir',
        'snooze' => 'Adiar',
        'snooze_options' => [
