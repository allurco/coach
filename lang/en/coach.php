...
return [
    ...
    'plan' => [
        ...
        'empty_pending' => 'Nothing pending. Breathe.',
        'empty_in_progress' => 'Nothing in progress.',
        'empty_completed' => "Nothing finished yet — let's get started.",
        'empty_all' => 'No actions in this goal yet. Ask the coach to create the first one.',
        'view_all' => 'View all →',
        'mark_done' => 'Mark done',
        'snooze' => 'Snooze',
        'snooze_options' => [
