{{-- Composer — textarea form + icon send button (prototype / ADR 0007).
     @submit does an optimistic insert: renders the user's orange bubble into
     the thread BEFORE the Livewire round-trip so the UI feels instant; the
     server-rendered .msg arrives later and the morph hook removes the
     [data-optimistic] placeholder. --}}
