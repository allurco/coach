    ...
    <div class="complete-modal-overlay" wire:click="cancelBudgetShare">
        <div class="complete-modal" @click.stop wire:click.stop style="max-width: 520px;">
            <div class="complete-modal-header">
                ...
                <div>
                    <div class="complete-modal-title">{{ __('finance::budget_flyout.share_modal_title') }}</div>
                </div>
            </div>

            <label class="complete-modal-label" for="budgetShareRecipient">{{ __('finance::budget_flyout.share_recipient_label') }}</label>
            <input type="text"
                   ...
                   placeholder="{{ __('finance::budget_flyout.share_recipient_placeholder') }}"
                   autofocus
                   wire:keydown.escape="cancelBudgetShare">

            <label class="complete-modal-label" for="budgetShareSubject">{{ __('finance::budget_flyout.share_subject_label') }}</label>
            <input type="text"
            ...
            <label class="complete-modal-label" for="budgetShareBody">{{ __('finance::budget_flyout.share_body_label') }}</label>
            ...
            <div class="complete-modal-footer">
                <button type="button" class="complete-modal-cancel" wire:click="cancelBudgetShare">
                    {{ __('finance::budget_flyout.share_cancel') }}
                </button>
                <button type="button"
                    ...
                    <span wire:loading.remove wire:target="confirmBudgetShare">
                        {{ __('finance::budget_flyout.share_send') }}
                    </span>
