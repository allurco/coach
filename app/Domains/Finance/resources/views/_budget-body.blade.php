{{-- Budget editor body — the hero income + 3 editable buckets + leisure
     punchline + actions. Rendered inline by the embedded BudgetTool inside
     the Workspace tool rail (the rail provides the drawer chrome + close).
     ADR 0007. --}}
@if ($budgetData)
